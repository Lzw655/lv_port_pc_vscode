 ...
 * Speaker related
 */
// Enable/Disable the log output of the speaker modules
#define ESP_BROOKESIA_CONF_SPEAKER_ENABLE_DEBUG_LOG                     (0)
#if ESP_BROOKESIA_CONF_SPEAKER_ENABLE_DEBUG_LOG

    #define ESP_BROOKESIA_CONF_SPEAKER_APP_ENABLE_DEBUG_LOG             (1)
    #define ESP_BROOKESIA_CONF_SPEAKER_DISPLAY_ENABLE_DEBUG_LOG         (1)
    #define ESP_BROOKESIA_CONF_SPEAKER_MANAGER_ENABLE_DEBUG_LOG         (1)
    #define ESP_BROOKESIA_CONF_SPEAKER_LAUNCHER_ENABLE_DEBUG_LOG        (1)
    #define ESP_BROOKESIA_CONF_SPEAKER_GESTURE_ENABLE_DEBUG_LOG         (1)
    #define ESP_BROOKESIA_CONF_SPEAKER_EMOJI_ENABLE_DEBUG_LOG           (1)
    #define ESP_BROOKESIA_CONF_SPEAKER_QUICK_SETTINGS_ENABLE_DEBUG_LOG  (1)
    #define ESP_BROOKESIA_CONF_SPEAKER_SPEAKER_ENABLE_DEBUG_LOG         (1)

#endif // ESP_BROOKESIA_CONF_SPEAKER_ENABLE_DEBUG_LOG
